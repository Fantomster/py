...
interests = [
    ...
    (7, "neaural networks"), (8, "neural networks"), (8, "deep learning"),
    (8, "Big Data"), (8, "artificial intelligence"), (9, "Hadoop"),
    (9, "Java"), (9, "MapReduce"), (9, "Big Data")
]

# finds users with certain interest
...
for user_id, interest in interests:
    interests_by_user_id[user_id].append(interests_by_user_id)
