...
import random
from DataScience_first_principles.linear_algebra.vectors import distance
...
def partial_difference_qoutient(f, v, i, h):
...
def estimate_gradient(f, v, h=0.00001):
    return [partial_difference_qoutient(f, v, i, h)
