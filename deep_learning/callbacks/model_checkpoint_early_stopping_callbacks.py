...
callbacks_list = [
    ...
    keras.callbacks.EarlyStopping(
        ...
        monitor='acc',
        # Interrupts training when accuracy has stopped improving for more that
...
model.compile(optimizer='rmsprop',
              ...
              # You monitor accuracy, it should be part of the model's metrics
              metrics=['acc'])

"""Note that because the callback will monitor validation loss and validation
